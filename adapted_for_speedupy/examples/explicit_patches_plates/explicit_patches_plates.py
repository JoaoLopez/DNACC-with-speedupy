...
def main():
    ...
    run(L=20 * nm, sigma=1 / (20 * nm) ** 2, beta_DeltaG0=-6,
        patch_radii=dict(upper=100 * nm, lower=100 * nm),
        plates=nice_patch)
    temp = subprocess.Popen(['gnuplot', 'plot_patch6.gp'])
    temp.terminate()
